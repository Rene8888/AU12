...
public class Control {
	 ...
	 * @param txt text which should be encrypted
	 * @param type type for the encrypt-method
	 ...
	 * @param txt text which should be decrypted
	 * @param type type for the decrypt-method
	 ...
	 * @param type type for which the parameter should be changed
	 * @param param new parameter
	 * @throws IllegalArgumentException when type is SubType.SHIFT and the param does not represents a number
	 */
